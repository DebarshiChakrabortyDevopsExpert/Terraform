...
resource "azurerm_private_endpoint" "private_endpoint_fun_app" {
  ...
  dynamic "private_dns_zone_group" {
    ...
    content {
      ...
      private_dns_zone_ids = flatten([for ids, value in try(private_dns_zone_group.value.dnszones, null) : "/subscriptions/xxxxxxxxxxxxxxxxxxxxxxxxx/resourceGroups/${value.dns_zone_rg_name}/providers/Microsoft.Network/privateDnsZones/${value.dns_zone_name}"])
    }
  }
}
...
resource "azurerm_private_endpoint" "private_endpoint_fun_app_slot" {
  ...
  dynamic "private_dns_zone_group" {
    ...
    content {
      name                 = try(private_dns_zone_group.value.name, null)
      private_dns_zone_ids = flatten([for ids, value in try(private_dns_zone_group.value.dnszones, null) : "/subscriptions/xxxxxxxxxxxxxxxxxxxxxxxxxx/resourceGroups/${value.dns_zone_rg_name}/providers/Microsoft.Network/privateDnsZones/${value.dns_zone_name}"])
    }
  }
}
