...
linux_function_app = {
  function_app1 = {
    linux_function_app = {
      ...
      location             = "eastus"
      https_only           = true
      service_plan_name    = "asp-org-prod-eus-02"
      service_plan_rg      = "rg-org-prod-eus-org"
      storage_account_name = "storgprodeusorg01"
      storage_rg_name      = "rg-org-prod-eus-org"
      application_insights_name = "appi-org-prod-eus-001"
      application_insights_rg   = "rg-org-prod-eus-monitoring"
      app_settings = {
        WEBSITE_RUN_FROM_PACKAGE=1
    ...
    func_app_vnets = {
        vnet1 = {
          subnet_name             = "snet-org-prod-eus-azfuncsubnet"
          vnet_name               = "vnet-org-prod-eus"
          vnet_rg_name            = "rg-org-prod-eus-network"
        }
    }
    ...
    function_app_pvt_endpnt = {
          funcapp_endpoint1 = {
              name                    = "priep-funapp-org-prod-eus-01"
              location                = "eastus"
              resource_group_name     = "rg-org-prod-eus-org"
              subnet_name             = "snet-org-prod-eus-app"
              vnet_name               = "vnet-org-prod-eus"
              vnet_rg_name            = "rg-org-prod-eus-network"
              private_connection_name = "prisc-funapp-org-prod-eus-01"
              private_dns_zone_group = {
...
logic_app_standard = {
    logic_app1 = {
        ...
        resource_group_name  = "rg-org-prod-eus-org"
        location             = "eastus"
        service_plan_name    = "asp-org-prod-eus-03"
        service_plan_rg      = "rg-org-prod-eus-org"
        storage_account_name = "storgprodeusorg01"
        storage_rg_name      = "rg-org-prod-eus-org"
        application_insights_name = "appi-org-prod-eus-001"
        ...
        logic_app_std_vnets = {
            vnet1 = {
                  subnet_name             = "snet-org-prod-eus-lgappsubnet"
                  vnet_name               = "vnet-org-prod-eus"
                  vnet_rg_name            = "rg-org-prod-eus-network"
            }
        }
        logic_app_std_pvt_endpnt = {
            pvtendpoint1 = {
                name                    = "priep-logicapp-org-prod-eus-01"
                location                = "eastus"
                resource_group_name     = "rg-org-prod-eus-org"
                subnet_name             = "snet-org-prod-eus-app"
                vnet_name               = "vnet-org-prod-eus"
                vnet_rg_name            = "rg-org-prod-eus-network"
                private_connection_name = "prisc-logicapp-org-prod-eus-01"
                private_dns_zone_group = {
