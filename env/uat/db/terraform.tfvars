...
sql_servers = {
  ...
  sql_server1 = {
    ms_sql_server = {
      ...
      location                      = "eastus"
      key_vault_name                = "kvorg01uateus"
      key_vault_rg                  = "rg-org-uat-eus-org"
    ...
    ms_sql_server_auditing_policy = {
      policy1 = {
        auditing_policy_storage_account_name    = "storguateusorg01"
        auditing_policy_storage_account_rg_name = "rg-org-uat-eus-org"
        enabled                                 = true
    ...
    ms_sql_security_alert_policy = {
        securitypolicy1 = {
            ...
            retention_days                          = 30
            security_policy_storage_account_name    = "storguateusorg01"
            security_policy_storage_account_rg_name = "rg-org-uat-eus-org"
        }
    }
    ...
    ms_sql_database = {
      sqldb1 = {
        ...
        threat_detection_storage_account_name    = "storguateusorg01"
        threat_detection_storage_account_rg_name = "rg-org-uat-eus-org"
    ...
    ms_sql_server_private_endpoint = {
      pvtendpoint1 = {
        name                    = "priep-sqldb-org-uat-eus-01"
        location                = "eastus"
        resource_group_name     = "rg-org-uat-eus-org"
        subnet_name             = "snet-org-uat-eus-data"
        vnet_name               = "vnet-org-uat-eus"
        vnet_rg_name            = "rg-org-uat-eus-network"
        private_connection_name = "prisc-sqldb-org-uat-eus-01"
...
synapse = {
  synapse1 = {
    synapse_workspace = {
      ...
      storage_account_name              = "storguateusorg02"
      data_lake_gen2_name               = "dtlkeorguateus002"
      storage_account_rg                = "rg-org-uat-eus-org"
    ...
    synapse_pvt_endpnt = {
      synapsepep1 = {
        name                    = "priep-synapse-org-uat-eus-01"
        location                = "eastus"
        resource_group_name     = "rg-org-uat-eus-org"
        subnet_name             = "snet-org-uat-eus-data"
        vnet_name               = "vnet-org-uat-eus"
        vnet_rg_name            = "rg-org-uat-eus-network"
        private_connection_name = "prisc-synapse-org-uat-eus-01"
        private_dns_zone_group = {
          name = "synapsegroup"
          dnszones = {
            zone1 = {
